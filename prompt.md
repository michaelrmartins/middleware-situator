...
Create a solid API for Situator database, with endpoint to retreave data from users, live events, daily access, person data and more. use the Querys bellow as reference for each endpoint. 

examples endpoints: 
/api/events?limit=50&offset=0&search=
/api/person-history?id=892&limit=10
/api/reports?type=doors
/api/reports?type=daily&start=1773716400000&end=1773802799999
/api/reports?type=auth&start=1773716400000&end=1773802799999
/api/reports?type=rfid&start=1773716400000&end=1773802799999
/api/reports?type=no-rfid&start=1773716400000&end=1773802799999
/api/health/hardware
